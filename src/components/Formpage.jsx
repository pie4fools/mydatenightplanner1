          ...
          <form>
            ...
            {formStep >= 1 && (
              <section className={formStep === 1 ? "block" : "hidden"}>
                <label className="text-gray-800 font-sans text-xl">From</label>
                <input type="date"
                className="w-full px-3 py-2.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-500 focus:outline-none"
                {...register("datefrom", {
                  valueAsDate: true,
                })}
                />
                <label className="text-gray-800 font-sans text-xl">To</label>
                <input type="date"
                class="w-full px-3 py-2.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-500 focus:outline-none"
                {...register("dateto", {
                  valueAsDate: true,
                })}
                />
                <label className="text-gray-800 font-sans text-xl">When</label>
                <input type="time"
                class="w-full px-3 py-2.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-500 focus:outline-none"
                {...register("time", {
                  valueAsDate: true,
              ...
              <section className={formStep === 4 ? "block mb-9" : "hidden"}>
                ...
                loop/>
                  ...
                  <div role="status">
                    ...
                    <h2 className="text-2xl my-6 italic font-sans text-center font-gray-500">Receive your custom date within an hour!</h2>
